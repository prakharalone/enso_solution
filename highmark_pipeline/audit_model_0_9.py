...
class SimpleEncoder:
    ...
    def fit(self, config, Y, exec_mode = "train"):
        if exec_mode == "train":
            ...
            csv_minio_urn = "minio://{}/label_encoder/audit_target_label_encoding".format(NAMESPACE)
            ...
            file_path = "minio://{}/label_encoder/audit_target_label_encoding".format(NAMESPACE)
