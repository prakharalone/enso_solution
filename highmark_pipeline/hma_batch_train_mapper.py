...
def hma_batch_train_mapper(config=None, **objects):
    mapper_dict = {
    ...
    mapped_local_csv_path = "/tmp/" + "mapped_train_batch_" + objects["document"][0]["metadata"]["properties"]["filename"]
    ...
    if "cas_stus_dscr" in hma_df:
        generic_df["cas_stus_dscr"] = hma_df["cas_stus_dscr"]
    else:
        generic_df["ec_dscr"] = hma_df["ec_dscr"]
